...
export class EZNft extends ethereum.SmartContract {
  static bind(address: Address): EZNft {
    return new EZNft("EZNft", address);
  }
  ...
  getCurrentTokenIdCounter(): BigInt {
    let result = super.call(
      "getCurrentTokenIdCounter",
      "getCurrentTokenIdCounter():(uint256)",
      []
    );
  ...
  try_getCurrentTokenIdCounter(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCurrentTokenIdCounter",
      "getCurrentTokenIdCounter():(uint256)",
      []
